...
console.log('API Key Check in Route:', process.env.OPENAI_API_KEY ? `YES - Starts with: ${process.env.OPENAI_API_KEY.substring(0, 5)}...` : 'NO - API KEY MISSING OR UNDEFINED! CHECK .env AND DOTENV CONFIG.');
  try {
